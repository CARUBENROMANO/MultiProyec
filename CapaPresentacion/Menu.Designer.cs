namespace CapaPresentacion
{
    partial class Menu
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuStrip1.Items.AddRange(new ToolStripItem[] { menuusuario, menustock, menuventas, menucompras, menuproveedores, menureportes, menuacerca });
            ...
            menuacerca.IconChar = FontAwesome.Sharp.IconChar.CircleInfo;
            ...
            menuacerca.Size = new Size(152, 64);
            menuacerca.Text = "Acerca de";
            menuacerca.TextImageRelation = TextImageRelation.TextAboveImage;
            // 
            // contenedor
            // 
